...
needle='''func handleCommand(id int) {\n''';handlers=['handleVendasUI12115','handleConsultaGlobal12115','handleEstoqueUI12115','handleFiadoUI12115','handleFinanceiroUI12115','handleCaixaUI12115','handleProdutosUI12115','handleRelatoriosUI12115']
...
s=s.replace(needle,insert,1);p.write_text(s,encoding='utf-8');print('UI 12.1.15 integrada: Produtos, Compras, Vendas, Estoque, Caixa, Consulta, Fiado, Financeiro e Relatorios.')
